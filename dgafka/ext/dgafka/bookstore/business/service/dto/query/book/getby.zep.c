...
ZEPHIR_INIT_CLASS(Dgafka_BookStore_Business_Service_Dto_Query_Book_GetBy) {
	...
	ZEPHIR_REGISTER_CLASS(Dgafka\\BookStore\\Business\\Service\\Dto\\Query\\Book, GetBy, dgafka, bookstore_business_service_dto_query_book_getby, dgafka_bookstore_business_service_dto_query_book_getby_method_entry, 0);

	zend_declare_property_null(dgafka_bookstore_business_service_dto_query_book_getby_ce, SL("orderBy"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(dgafka_bookstore_business_service_dto_query_book_getby_ce, SL("type"), ZEND_ACC_PUBLIC TSRMLS_CC);
